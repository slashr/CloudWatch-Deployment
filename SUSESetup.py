...
def install_dependencies():
	subprocess.call(["zypper", "--non-interactive", "in", "perl-DateTime"])
	subprocess.call(["zypper", "--non-interactive", "in", "perl(LWP::Protocol::https)"])
	subprocess.call(["zypper", "--non-interactive", "in", "unzip"])
