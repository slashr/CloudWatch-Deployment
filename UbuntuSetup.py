...
def install_dependencies():
	...
	subprocess.call(["sudo", "apt-get", "-y", "install", "libwww-perl"])
	subprocess.call(["sudo", "apt-get", "-y", "install", "libcrypt-ssleay-perl"])
	subprocess.call(["sudo", "apt-get", "-y", "install", "libswitch-perl"])
	subprocess.call(["sudo", "apt-get", "-y", "install", "libdatetime-perl"])
	subprocess.call(["sudo", "apt-get", "-y", "install", "unzip"])
